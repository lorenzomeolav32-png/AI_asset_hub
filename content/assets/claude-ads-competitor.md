...
summary: >-
  Researches what competitors are actually running in official ad
  transparency libraries, and keeps every observation separate from guesses
  about their spend or strategy.
category: marketing
...
- Separates direct observations from inferred audience, spend, performance or strategy, and never presents estimates as account facts.
